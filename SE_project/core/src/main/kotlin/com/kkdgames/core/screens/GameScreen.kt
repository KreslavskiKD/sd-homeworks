...
class GameScreen(val game: MainGame, val assets: Assets) : Screen {
    ...
    private var dropImage: Texture = assets.manager.get(Assets.dropletTexture)
    private var bucketImage: Texture = assets.manager.get(Assets.bucketTexture)
    private var dropSound: Sound = assets.manager.get(Assets.dropletSound)
    private var rainMusic: Music = assets.manager.get(Assets.rainSound)
